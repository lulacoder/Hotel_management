    ...
    <div className="landing-page min-h-screen bg-slate-950 text-slate-100">
      ...
      <section className="landing-hero relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="landing-hero-bg absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(96,165,250,0.22),transparent_40%),radial-gradient(circle_at_75%_30%,rgba(99,102,241,0.18),transparent_42%),linear-gradient(180deg,#020617_0%,#020617_100%)]" />
          <div
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-20 lg:pt-20 lg:pb-28">
          <div className="grid items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
            <div>
              <div className="landing-badge inline-flex items-center gap-2 rounded-full border border-blue-500/30 bg-blue-500/10 px-4 py-2 text-sm font-medium text-blue-300 mb-7">
                <Sparkles size={16} />
              ...
              <h1 className="landing-title text-5xl sm:text-6xl lg:text-7xl font-bold leading-[1.02] tracking-tight mb-6">
                ...
                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-blue-300 via-blue-400 to-indigo-500">
            ...
            <div className="lg:pl-8">
              <div className="landing-info-card rounded-3xl border border-blue-500/25 bg-slate-900/65 p-7 shadow-[0_30px_100px_-45px_rgba(59,130,246,0.65)] backdrop-blur-xl">
                <img
                  src="/logo.png"
                  alt="Luxe Hotels"
                  className="h-16 w-auto object-contain logo-tight"
                />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <article className="landing-feature-card rounded-2xl border border-slate-800 bg-slate-900/55 p-6">
              <Compass className="text-blue-400 mb-4" size={22} />
            ...
            <article className="landing-feature-card rounded-2xl border border-slate-800 bg-slate-900/55 p-6">
              <ShieldCheck className="text-blue-400 mb-4" size={22} />
              <h3 className="text-lg font-semibold text-slate-100 mb-2">
      ...
      <footer className="landing-footer py-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-5">
          <img
            src="/logo.png"
            alt="Trip Way Hotels"
            className="h-11 w-auto object-contain opacity-95 logo-tight"
          />
