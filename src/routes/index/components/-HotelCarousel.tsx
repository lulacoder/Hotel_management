      ...
      <div className="relative aspect-[4/5] overflow-hidden bg-slate-800">
        ...
        <div className="absolute inset-x-0 bottom-0 p-5 sm:p-6 z-10">
          <div className="mb-4">
            ...
            <p className="mt-1 flex items-center gap-1.5 truncate text-sm text-slate-100 sm:text-base font-medium">
              <MapPin className="size-4 shrink-0 text-violet-300" aria-hidden />
