  ...
  return (
    <div className="flex flex-col sm:flex-row gap-3">
      <select
        ...
        className="flex-1 px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-slate-200 focus:outline-none focus:border-violet-500/50 transition-all"
      >
