...
export const enMessages = {
  ...
  'landing.searchCheckOut': 'Check out',
  'landing.searchDatesPlaceholder': 'Add dates',
  'landing.searchGuests': 'Guests',
  'landing.searchGuestsPlaceholder': '2 guests',
  'landing.popularDestinations': 'Popular destinations',
  'landing.destinations': 'Destinations',
  'landing.matchingHotels': 'Hotels',
  'landing.viewAllFor': 'View all results for "{query}"',
  'landing.hotelsCount': '{count} hotels',
  'landing.oneHotelCount': '1 hotel',
  'landing.noMatchesFound': 'No matching destinations or hotels',
  ...
  'landing.featureSecureDesc': 'Sign in before managing stays',
  'landing.featureFlexibleTitle': 'Date-Based Booking',
  'landing.featureFlexibleDesc': 'Choose check-in and checkout dates',
  'landing.featureDealsTitle': 'Booking Management',
  ...
  'landing.stayBoutiqueDesc': 'Warm private stays with a quieter pace.',
  ...
  'complaint.validation.subjectMax': 'Subject must be 120 characters or less.',
  ...
  'bookingModal.paymentRefundedMessage': 'This Chapa payment was refunded.',
  ...
  'admin.invitations.description':
    'Send secure, time-limited invitations and follow every handoff from delivery to acceptance.',
  'admin.invitations.accessDenied':
    'Only room administrators and hotel administrators can manage staff invitations.',
  'admin.invitations.newInvitation': 'New invitation',
  'admin.invitations.roomAdminHint':
    'Invite a hotel administrator or cashier to any hotel.',
  'admin.invitations.hotelAdminHint':
    'Invite a cashier to support your assigned hotel.',
  'admin.invitations.email': 'Staff email',
  'admin.invitations.emailPlaceholder': 'staff@example.com',
  'admin.invitations.hotel': 'Hotel',
  'admin.invitations.chooseHotel': 'Choose a hotel...',
  'admin.invitations.role': 'Hotel role',
  'admin.invitations.send': 'Send invitation',
  'admin.invitations.sending': 'Sending invitation...',
  'admin.invitations.created': 'Invitation sent successfully.',
  'admin.invitations.createdEmailFailed':
    'Invitation created, but the email could not be queued. Use Resend to try again.',
  'admin.invitations.createFailed': 'Failed to create invitation.',
  'admin.invitations.resent': 'A fresh invitation link was sent.',
  'admin.invitations.resendEmailFailed':
    'The link was refreshed, but email delivery failed. Try resending again.',
  'admin.invitations.resendFailed': 'Failed to resend invitation.',
  'admin.invitations.revokedSuccess': 'Invitation revoked.',
  'admin.invitations.revokeFailed': 'Failed to revoke invitation.',
  'admin.invitations.confirmRevoke':
    'Revoke this invitation? Its current link will stop working immediately.',
  'admin.invitations.searchPlaceholder': 'Search by email or hotel...',
  'admin.invitations.statusFilter': 'Filter invitations by status',
  'admin.invitations.status.all': 'All statuses',
  'admin.invitations.status.pending': 'Pending',
  'admin.invitations.status.expired': 'Expired',
  'admin.invitations.status.accepted': 'Accepted',
  'admin.invitations.status.revoked': 'Revoked',
  'admin.invitations.metric.pending': 'Pending',
  'admin.invitations.metric.accepted': 'Accepted',
  'admin.invitations.metric.attention': 'Needs attention',
  'admin.invitations.table.recipient': 'Recipient',
  'admin.invitations.table.assignment': 'Assignment',
  'admin.invitations.table.status': 'Status',
  'admin.invitations.table.activity': 'Activity',
  'admin.invitations.table.actions': 'Actions',
  'admin.invitations.loading': 'Loading invitations...',
  'admin.invitations.empty': 'No invitations match this view.',
  'admin.invitations.by': 'Invited by {email}',
  'admin.invitations.deliveryFailed': 'Email delivery failed',
  'admin.invitations.sentOn': 'Sent {date}',
  'admin.invitations.expiresOn': 'Expires {date}',
  'admin.invitations.resend': 'Resend',
  'admin.invitations.revoke': 'Revoke',
  'staffInvite.eyebrow': 'Hotel staff invitation',
  'staffInvite.signInTitle': 'Continue with the invited email',
  'staffInvite.signInDescription':
    'Sign in if you already have an account, or create one using the exact email that received this invitation.',
  'staffInvite.signIn': 'Sign in',
  'staffInvite.createAccount': 'Create account',
  'staffInvite.loading': 'Loading your invitation...',
  'staffInvite.checking': 'Checking your account and invitation...',
  'staffInvite.unavailableEyebrow': 'Invitation unavailable',
  'staffInvite.unavailableTitle': 'This invitation does not match this account',
  'staffInvite.unavailableDescription':
    'Sign in with the exact invited email address, or ask the administrator to send a new invitation.',
  'staffInvite.expiredEyebrow': 'Invitation expired',
  'staffInvite.expiredTitle': 'This invitation needs a fresh link',
  'staffInvite.expiredDescription':
    'The seven-day acceptance window has ended. Ask the administrator to resend the invitation.',
  'staffInvite.revokedEyebrow': 'Invitation revoked',
  'staffInvite.revokedTitle': 'This invitation is no longer active',
  'staffInvite.revokedDescription':
    'The administrator revoked this invitation. Contact them if you still need hotel access.',
  'staffInvite.acceptedEyebrow': 'Invitation accepted',
  'staffInvite.acceptedTitle': 'Your hotel access is already active',
  'staffInvite.acceptedDescription':
    'This invitation has already been accepted. Continue to the operations dashboard.',
  'staffInvite.openDashboard': 'Open dashboard',
  'staffInvite.title': 'Review your hotel access',
  'staffInvite.description':
    'Confirm the assignment below before joining the hotel operations team.',
  'staffInvite.hotel': 'Hotel',
  'staffInvite.role': 'Role',
  'staffInvite.expires': 'Invitation expires',
  'staffInvite.emailNotice':
    'Access will be attached to the verified account for {email}.',
  'staffInvite.missingToken':
    'This link is missing its secure token. Open the latest invitation email and try again.',
  'staffInvite.accept': 'Accept invitation',
  'staffInvite.accepting': 'Activating access...',
  'staffInvite.acceptFailed': 'Failed to accept invitation.',
  'staffInvite.securityFooter':
    'Staff access is protected by your verified email and a single invitation link.',
  ...
  'admin.announcements.form.bodyPlaceholder': 'Write your announcement here...',
  ...
  'admin.announcements.form.bodyMin': 'Message must be at least 10 characters',
  'admin.announcements.form.bodyMax': 'Message must be at most 2000 characters',
  ...
  'grid.instantBooking': 'Instant Booking',
  'footer.verifiedStays': 'Verified Stays',
  'footer.verifiedStaysDesc': 'Curated, quality-inspected hotels',
  'footer.securePayments': 'Secure Payments',
  'footer.securePaymentsDesc': 'Instant checkout via Chapa & cards',
  'footer.guestCare': 'Dedicated Guest Care',
  'footer.guestCareDesc': 'Assistance before, during & after',
  ...
  'footer.browseStays': 'Browse Stays',
  'footer.myReservations': 'My Reservations',
  'footer.guestSignIn': 'Guest Sign In',
  'footer.createAccount': 'Create Account',
  'footer.address': 'Bole, Addis Ababa, Ethiopia',
} as const
